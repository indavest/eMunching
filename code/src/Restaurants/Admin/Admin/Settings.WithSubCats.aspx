...
<script runat="server">
	...
	Sub Page_Load(sender As Object, e As EventArgs)
        ...
        dsSubCategories.ConnectionString = connectionObject("connectionStringApp")
        AvailCities.ConnectionString = connectionObject("connectionStringApp")
...
Dim objConn As New SqlConnection(connectionObject("connectionStringApp"))
	...
	Public Function GetDDL_Art() As DataTable
		...
		myDirInfo = New DirectoryInfo(Server.MapPath("../ArtWork/CategoryIcons/"))
									...
									<Columns>
										...
										<asp:TemplateField HeaderText="City" SortExpression="City" itemstyle-wrap="true">
											<EditItemTemplate>
												...
												<asp:SqlDataSource ID="AvailCities" 
																   runat="server" 
																   SelectCommand="p_gv_GetCities @RestID">
													<SelectParameters>
				...
				<div id="tab2" class="tab_content">
					<h2>Menu Settings</h2>
						...
						<asp:SqlDataSource ID="dsCategories" runat="server"
							...
							UpdateCommand="p_gv_UpdateCategory @MenuItemGroupID,@RestID,@MenuItemGroup,@MenuItemGroupDesc,@MenuItemGroupImage">
							<DeleteParameters>
					...
					<hr />
					<br/>
					<b>Menu Sub-Categories</b><br />
						<asp:GridView ID="GridView2a" 
									  runat="server"
									  AutoGenerateColumns="False" 
									  DataKeyNames="CatID"
									  ...
									  CssClass="mGrid"
									  PageSize="30"
									  emptydatatext="There aren't any existing sub-categories."
									  PagerStyle-CssClass="pgr"
									  AlternatingRowStyle-CssClass="alt"
									  >
									<Columns>
										...
										<asp:TemplateField HeaderText="Category" SortExpression="MenuItemGroup" itemstyle-wrap="true">
											<ItemTemplate>
												<asp:Label ID="Label9" runat="server" Text='<%# Bind("MenuItemGroup") %>'></asp:Label>
											</ItemTemplate>               
										</asp:TemplateField>
										
										<asp:TemplateField HeaderText="Sub-Category" SortExpression="Name" itemstyle-wrap="true">
											<EditItemTemplate>
						...
						<asp:SqlDataSource ID="dsSubCategories" runat="server"
							ProviderName="System.Data.SqlClient" 
							SelectCommand="p_gv_GetSubCategories @RestID"
							DeleteCommand="p_gv_DeleteSubCategory @CatID"
							UpdateCommand="p_gv_UpdateSubCategory @CatID,@RestID,@Name">
							<DeleteParameters>
						...
						<table>
							...
							<tr>
								<th>Sub-Category:</th>
								<td><asp:TextBox runat="server" ID="txtSubCatName" cssclass="input"/></td>
							</tr>
						</table>
						<br />
						<asp:Button	id="btnSubmit2a" Text="Create Sub-Category" Runat="server" cssclass="input" onclick="SubmitButton2a_Click" />
					<br>
				</div>
