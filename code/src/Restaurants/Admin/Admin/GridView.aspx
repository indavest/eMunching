...
<script runat="server">
    ...
    Private Sub CreateDataSource(ByVal sourceName As SqlDataSource, ByVal sourceID As String, ByVal selectCommand As String, selectParameter As Integer)
...
<body>
    ...
    <div id="container">
        ...
        <asp:GridView ID="GridView1" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Group" SortExpression="MenuGroup" itemstyle-width="100px" itemstyle-wrap="true">
				 ...
				 <asp:TemplateField HeaderText="Combo Price" SortExpression="ComboPrice" ItemStyle-HorizontalAlign="Right">
                    <EditItemTemplate>
                        <asp:TextBox ID="ComboPrice" runat="server" cssclass="input" Text='<%# Bind("ComboPrice") %>' size="5"></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label10" runat="server" Text='<%# Bind("FmComboPrice") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <asp:TextBox ID="ComboPriceTextBox" Runat="server" cssclass="input" size="5"></asp:TextBox>
                    </FooterTemplate>                 
                </asp:TemplateField>

				 <asp:TemplateField HeaderText="Dis. Price" SortExpression="DiscountPrice" ItemStyle-HorizontalAlign="Right">
                    <EditItemTemplate>
                        <asp:TextBox ID="DiscountPrice" runat="server" cssclass="input" Text='<%# Bind("DiscountPrice") %>' size="5"></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label11" runat="server" Text='<%# Bind("FmDiscountPrice") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
				 ...
				 <asp:TemplateField HeaderText="Childs Plate?" SortExpression="ChildsPlate" ItemStyle-HorizontalAlign="Center">
                    <EditItemTemplate>
                        <asp:DropDownList ID="ChildsPlate" 
										  runat="server" 
										  cssclass="input"
										  SelectedValue='<%# Bind("ChildsPlate", "{0}") %>'>
							<asp:listitem value="0" text="0" />
							<asp:listitem value="1" text="1" />
						</asp:DropDownList>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("ChildsPlate") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
						<asp:dropdownlist runat="server" id="ddlChildsPlateNew" cssclass="input">
							<asp:listitem value="0" text="0" />
							<asp:listitem value="1" text="1" />
						</asp:dropdownlist>
                    </FooterTemplate>                 
		...
		<asp:SqlDataSource ID="SqlDataSource1" runat="server"
            ...
            UpdateCommand="p_gv_UpdateMenuItems @MenuItemID,@MenuGroup,@ItemImage1,@ItemImage2,@ItemImage3,@Item,@ItemDesc,@ItemPrice,@ComboPrice,@DiscountPrice,@ChildsPlate,@Veg,@ChefSpecial">
            <DeleteParameters>
