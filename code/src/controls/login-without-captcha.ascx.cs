...
public partial class controls_login_without_captcha : System.Web.UI.UserControl
{
    //-------------------------------------------------------------------------------------------------
    ...
    protected string FromEmailAddress = "support@themobilisgroup.com"; // from email used for new credentials
    //--------------------------------------------------------------------------------------------------
    ...
    protected void Login1_Authenticate(object sender, AuthenticateEventArgs e)
    {
        ...
        //{
            ...
            if (Membership.ValidateUser(loginUsername, loginPassword))
            {
				...
				//session["RestUser"] = loginUsername;
            }
            else
            {
                e.Authenticated = false;
