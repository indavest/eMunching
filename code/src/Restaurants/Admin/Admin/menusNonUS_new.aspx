	...
	Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs)
		...
		Try
			If e.CommandName.Equals("New") Then
				...
				Dim cmd As New SqlCommand("p_gv_InsertMenuItemNonUS @RestID,@Breakfast,@Brunch,@Lunch,@Supper,@Dinner,@MenuGroup,@ItemImage1,@ItemImage2,@ItemImage3,@Item,@ItemDesc,@ItemPriceA,@DiscountPrice,@Veg,@ChefSpecial", conn)
				...
				<div id="tab1" class="tab_content">
					...
					<div id="container">
								...
								<Columns>
									...
									<asp:TemplateField HeaderText="Meal Types" SortExpression="MealTypes" itemstyle-width="75px" itemstyle-wrap="true">
										<EditItemTemplate>
											...
											<asp:CheckBox Text="Supper" ID="Supper" Runat=server Checked='<%# Bind("Supper")%>'/>
										</EditItemTemplate>
										<ItemTemplate>
										...
										<FooterTemplate>
											...
											<asp:CheckBox Text="Supper" ID="Supper" Runat=server/>
										</FooterTemplate>                 
									</asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Thumbnail" SortExpression="ItemImage1">
										<EditItemTemplate>
											Thumbnail: <asp:DropDownList id="ItemImage1" runat="server" cssclass="input" DataSource='<%# GetDDL_Art()%>' DataTextField="Name" DataValueField ="Name" SelectedValue='<%# Bind("ItemImage1") %>'></asp:DropDownList><br>
										</EditItemTemplate>
										<ItemTemplate>
											Thumbnail: <asp:Label ID="Label4" runat="server" Text='<%# Bind("ItemImage1") %>'></asp:Label><br>
										</ItemTemplate>
										<FooterTemplate>
											Img 1: <a href="#" class="tt"><IMG SRC="/images/help 16x16.png" WIDTH="16" HEIGHT="16" BORDER="0" ALT=""><span class="tooltip"><span class="top"></span><span class="middle">Thumbnail Image:<br> This is for Thumb + Signature menu representation!</span><span class="bottom"></span></span></a><asp:DropDownList id="ItemImage1TextBox" runat="server" cssclass="input" DataSource='<%# GetDDL_Art()%>' DataTextField="Name" DataValueField ="Name"></asp:DropDownList><br>
										</FooterTemplate>                 
									</asp:TemplateField>
									 ...
									 <asp:TemplateField HeaderText="Item" SortExpression="Item" itemstyle-width="75px" itemstyle-wrap="true">
										...
										<FooterTemplate>
											...
											<asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="ItemTextBox" validationgroup="NewMenuItemGroup" Text="Required" runat="server" />
										</FooterTemplate>                 
									</asp:TemplateField>
									 ...
									 <asp:TemplateField HeaderText="Item Desc" SortExpression="ItemDesc" itemstyle-width="100px" itemstyle-wrap="true">
										...
										<FooterTemplate>
											...
											<asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="ItemDescTextBox" validationgroup="NewMenuItemGroup" Text="Required" runat="server" />
										</FooterTemplate>                 
									</asp:TemplateField>
									 ...
									 <asp:TemplateField HeaderText="Price" SortExpression="ItemPriceA" ItemStyle-HorizontalAlign="Right">
										...
										<FooterTemplate>
											...
											<asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="ItemPriceTextBox" validationgroup="NewMenuItemGroup" Text="Required" runat="server" />
									...
									<asp:TemplateField HeaderText="Discount Price" SortExpression="DiscountPrice" ItemStyle-HorizontalAlign="Right">
										...
										<FooterTemplate>
											...
											<asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="DiscountPriceTextBox" validationgroup="NewMenuItemGroup" Text="Required" runat="server" />
							...
							<asp:SqlDataSource ID="SqlDataSource1" runat="server"
								...
								InsertCommand="p_gv_InsertMenuItemNonUS @RestID,@Breakfast,@Brunch,@Lunch,@Supper,@Dinner,@MenuGroup,@ItemImage1,@ItemImage2,@ItemImage3,@Item,@ItemDesc,@ItemPriceA,@DiscountPrice,@Veg,@ChefSpecial"
								SelectCommand="p_gv_SelectRestaurantMenuItemsNonUS @RestID"
								UpdateCommand="p_gv_UpdateMenuItemsNonUS @MenuItemID,@Breakfast,@Brunch,@Lunch,@Supper,@Dinner,@MenuGroup,@ItemImage1,@ItemImage2,@ItemImage3,@Item,@ItemDesc,@ItemPriceA,@DiscountPrice,@Veg,@ChefSpecial">
								<DeleteParameters>
