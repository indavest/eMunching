	...
	Sub SubmitButton_Click(s As Object, e As EventArgs)
			...
			If chk1.Checked = True
				Try
					...
					mail.Body = "Hi,<br /><br />There is a new Beta Sign-up from <strong>"+name.Text+"</strong>. Please find all the details below:<br />" & _
								"Name: " + name.Text + "<br>" & _
								"Email: " + email.Text + "<br>" & _
								"Phone Number: " + number.Text + "<br>" & _
								"Restaurant Name: " + rest.Text + "<br>" & _
								"Website: " + website.Text + "<br>"
					SmtpMail.SmtpServer = "s2smtpout.secureserver.net"
					SmtpMail.Send(mail)
					msg.Text = "<div class='successMsg'><div class='successMsgTop'></div><div class='successMsgMid'><p>Thanks for your interest in eMunching. We will contact you when openings become available.</p><input type='button' value='Ok' name='go' class='btnOk' onclick='indexReturn()' /></div><div class='successMsgFoot'></div></div>"
   ...
   <div id="signUpLoader">
    ...
    <div id="signUpScreen">
	 ...
	 <div id="signupForm">
		   ...
		   <div id="term" style="padding:0 0 5px 10px;">
