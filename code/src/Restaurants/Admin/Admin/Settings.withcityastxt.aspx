...
<script type="text/javascript">
	$(document).ready(function() {
		...
		//AC Cities Handler
		$("#<%= txtSearch.ClientID%>").autocomplete('/controls/AC_Cities.ashx');
					...
					<h2>Locations Configuration</h2>
						<asp:GridView ID="GridView1" 
									...
									<Columns>
										...
										<asp:TemplateField HeaderText="State/Region" SortExpression="Region" itemstyle-wrap="true">
											<ItemTemplate>
												<asp:Label ID="Label4" runat="server" Text='<%# Bind("Region") %>'></asp:Label>
											</ItemTemplate>               
										</asp:TemplateField>

										<asp:TemplateField HeaderText="Country" SortExpression="Country" itemstyle-wrap="true">
											<ItemTemplate>
						...
						<table>
							...
							<tr>
								...
								<td><asp:TextBox  id="txtSearch" runat="server" cssclass="input" /></td>
							</tr>
							<tr>
								<th>Phone Number:</th>
