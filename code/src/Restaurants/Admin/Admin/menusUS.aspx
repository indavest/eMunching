	...
	Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs)
		...
		Try
			If e.CommandName.Equals("New") Then
                ...
                Dim cmd As New SqlCommand("p_gv_InsertMenuItemUS @RestID,@Breakfast,@Brunch,@Lunch,@Supper,@Dinner,@MorningTeaElevenses,@AfternoonTea,@MenuGroup,@ItemImage1,@ItemImage2,@ItemImage3,@Item,@ItemDesc,@ItemPriceA,@DiscountPrice,@ChefSpecial,@MenuType", conn)
								...
								<Columns>
									...
									<asp:TemplateField HeaderText="Meal Types" SortExpression="MealTypes" itemstyle-width="75px" itemstyle-wrap="true">
										<EditItemTemplate>
                                            ...
                                            <asp:CheckBox Text="Morning Tea" ID="MorningTea" Runat=server Checked='<%# Bind("MorningTeaElevenses")%>'/><br />
									...
									<asp:TemplateField HeaderText="Group" SortExpression="MenuGroup" itemstyle-width="50px" itemstyle-wrap="true">
									 ...
									 <asp:TemplateField HeaderText="Image 1" SortExpression="ItemImage1">
										...
										<FooterTemplate>
											...
											Img 3: <a href="#" class="tt"><IMG SRC="/images/help 16x16.png" WIDTH="16" HEIGHT="16" BORDER="0" ALT=""><span class="tooltip"><span class="top"></span><span class="middle">THUMBNAIL Image:<br> Remember to select an image that is 16x16 pixels!</span><span class="bottom"></span></span></a><asp:DropDownList id="ItemImage3TextBox" runat="server" cssclass="input" DataSource='<%# GetDDL_Art()%>' DataTextField="Name" DataValueField ="Name"></asp:DropDownList>
										</FooterTemplate>                 
									</asp:TemplateField>
									 ...
									 <asp:TemplateField HeaderText="Price" SortExpression="ItemPriceA" ItemStyle-HorizontalAlign="Right">
										...
										<FooterTemplate>
											...
											<asp:RegularExpressionValidator ID="regexpItemPrice" validationgroup="NewMenuItemGroup" runat="server" ErrorMessage="Numeric Value Only" ControlToValidate="ItemPriceTextBox"                   ValidationExpression="^(-)?\d+(\.\d\d)?$" />
										</FooterTemplate>                 
									</asp:TemplateField>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
							...
							<asp:SqlDataSource ID="SqlDataSource1" runat="server"
								...
								InsertCommand="p_gv_InsertMenuItemUS @RestID,@Breakfast,@Brunch,@Lunch,@Supper,@Dinner,@MenuGroup,@ItemImage1,@ItemImage2,@ItemImage3,@Item,@ItemDesc,@ItemPriceA,@DiscountPrice,@ChefSpecial,@MorningTeaElevenses,@AfternoonTea,@MenuType"
								SelectCommand="p_gv_SelectRestaurantMenuItemsUS @RestID"
								UpdateCommand="p_gv_UpdateMenuItemsUS @MenuItemID,@Breakfast,@Brunch,@Lunch,@Supper,@Dinner,@MenuGroup,@ItemImage1,@ItemImage2,@ItemImage3,@Item,@ItemDesc,@ItemPriceA,@DiscountPrice,@ChefSpecial,@MorningTeaElevenses,@AfternoonTea,@MenuTypeId">
								<DeleteParameters>
